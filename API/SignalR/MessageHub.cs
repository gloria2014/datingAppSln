...
namespace DatingApp_6.SignalR
{
    ...
    public class MessageHub: Hub
    {
        ...
        public async Task SendMessage(CreateMessageDto createMessageDto)
        {
            ...
            var recipient = await _userRepository.GetUserByUserNameAsync(createMessageDto.RecipientUsername); // _unitOfWork.UserRepository.GetUserByUsernameAsync(createMessageDto.RecipientUsername);
            ...
            {
                /* entra aca cuando el usuario no esta conectado */
            ...
            {
                /*  por ahora se pone else porque no entra n el if */
                await Clients.Group(groupName).SendAsync("NewMessage", _mapper.Map<MessageDto>(message));
        ...
        private async Task<Group> RemoveFromMessageGroup()
        {
           ...
           if(await _messageRepository.SaveAllAsync()) return group;
            ...
            throw new HubException("fallo al remover el grupo");
        }
